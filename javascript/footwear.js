...
function homePage()
{
    document.getElementById('vedioContainer').style.display='block'
    document.getElementById('shoeContainer').style.display='flex'
    document.getElementById('shoeContainer1').style.display='flex'
    document.getElementById("photos").style.display="none"
    document.getElementById("photos1").style.display="none"
    document.getElementById("photos2").style.display="none"
    document.getElementById("photos3").style.display="none"
